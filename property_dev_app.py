# Property Development Financial Model - Streamlit App Version (Upgraded)
...
contingency_percent = st.sidebar.slider("Contingency Percentage (%)", min_value=0.0, max_value=1.0, value=0.10)
